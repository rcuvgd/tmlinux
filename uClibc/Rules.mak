...
#
# FIXME: Need to deal with CONFIG_TMSIM
#
ifeq ($(TARGET_ARCH),trimedia)
	-include $(KERNEL_SOURCE)/.config
	SYMRENAME= -symbolrename _calloc=_tmlinux_calloc  	\
		-symbolrename _free=_tmlinux_free  		\
		-symbolrename _malloc=_tmlinux_malloc  		\
		-symbolrename _realloc=_tmlinux_realloc 	\
		-symbolrename _longjmp=_tmlinux_longjmp 	\
		-symbolrename _memmove=_tmlinux_memmove 	\
		-symbolrename _memset=_tmlinux_memset 		\
		...
		-symbolrename _atexit=_tmlinux_atexit 		\
		...
		-symbolrename _putc=_tmlinux_putc 		\
		...
		-symbolrename _strcat=_tmlinux_strcat  		\
		-symbolrename _strchr=_tmlinux_strchr 		\
		-symbolrename _strcmp=_tmlinux_strcmp  		\
		-symbolrename _strcpy=_tmlinux_strcpy  		\
		-symbolrename _strncat=_tmlinux_strncat  	\
		-symbolrename _strncmp=_tmlinux_strncmp  	\
		...
		-symbolrename _bsearch=_tmlinux_bsearch  	\
		-symbolrename _signal=_tmlinux_signal  		\
		-symbolrename _system=_tmlinux_system  		\
		-symbolrename _sleep=_tmlinux_sleep 		\
		-symbolrename _getenv=_tmlinux_getenv 		\
		-symbolrename _putenv=_tmlinux_putenv 		\
		-symbolrename _close=_tmlinux_close 		\
		-symbolrename _closedir=_tmlinux_closedir 	\
		-symbolrename _fcntl=_tmlinux_fcntl 		\
		-symbolrename _fstat=_tmlinux_fstat 		\
		-symbolrename _isatty=_tmlinux_isatty 		\
		-symbolrename _opendir=_tmlinux_opendir 	\
		-symbolrename _read=_tmlinux_read 		\
		-symbolrename _readdir=_tmlinux_readdir 	\
		-symbolrename _stat=_tmlinux_stat 		\
		...
		-symbolrename _ungetc=_tmlinux_ungetc 		\
		...
		-symbolrename _strtoull=_tmlinux_strtoull 	\
		-symbolrename _tolower=_tmlinux_tolower 	\
		-symbolrename _toupper=_tmlinux_toupper 	\
		-symbolrename _tmpnam=_tmlinux_tmpnam 		\
		...
		-symbolrename _scanf=_tmlinux_scanf 		\
	...
	CPU_CFLAGS-$(CONFIG_LITTLE_ENDIAN) += -el
	CPU_CFLAGS-$(CONFIG_BIG_ENDIAN) += -eb
	CPU_CFLAGS-$(CONFIG_FP64) 	+= -fp64
	CPU_CFLAGS-$(CONFIG_FP32) 	+= -fp32
	CPU_CFLAGS-y += -D__trimedia__ -I$(TCS_PATH)/include
	STRIP_FLAGS = 
endif
...
XWARNINGS=$(subst ",, $(strip $(WARNINGS))) 
...
CFLAGS:=$(XWARNINGS) $(CPU_CFLAGS) $(SSP_CFLAGS) \
	-nostdinc -D_LIBC -I$(top_builddir)include -I.
