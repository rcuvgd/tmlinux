...
{
	return __fputc_unlocked_internal(c,stream);
}
int attribute_hidden fputc_unlocked(int c, register FILE *stream)
{
	return __fputc_unlocked_internal(c,stream);
}
int attribute_hidden putc_unlocked(int c, register FILE *stream)
{
	return __fputc_unlocked_internal(c,stream);
}
#ifndef __UCLIBC_HAS_THREADS__
int attribute_hidden fputc(int c, register FILE *stream)
{
	return __fputc_unlocked_internal(c,stream);
}
int attribute_hidden putc(int c, register FILE *stream)
{
	return __fputc_unlocked_internal(c,stream);
}
#endif 
