...
loff_t __libc_lseek64(int fd, loff_t offset, int whence)
{
	...
	ret=__syscall_llseek(fd, (off_t) (offset >> 32),(off_t) (offset & 0xffffffff), &result, whence);

	return(loff_t) ret? ret:result;
}
...
#else
loff_t _llseek(int fd, loff_t offset, int whence)
{
